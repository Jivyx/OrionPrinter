...
translate([-height_arm*2,height_arm,-height_arm]) {
    rotate([0,90,0]) {
        CyS(r=depth_arm-height_arm, h=height_arm, w1=0, w2=90,center=false);
    }
}

translate([-depth_arm-height_arm,height_arm,-height_arm]) {
    rotate([0,90,0]) {
        CyS(r=depth_arm-height_arm, h=height_arm, w1=0, w2=90,center=false);
    }
}
